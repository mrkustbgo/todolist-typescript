...
import { WELCOME_DETAILS } from "../../constants";
...
const WelcomePage = () => {
  ...
  /* STATE VARIABLES */
  const [activeWelcomePage, setActiveWelcomePage] = useState<number>(1);
  ...
  const handleData = (): DataProps => {
    switch (activeWelcomePage) {
      case 1:
        return WELCOME_DETAILS[0];
      case 2:
        return WELCOME_DETAILS[1];
      case 3:
        return WELCOME_DETAILS[2];
      case 4:
        return WELCOME_DETAILS[3];
      default:
        return WELCOME_DETAILS[4];
    }
  };
      ...
      <div id="modal">
        ...
        <div id="modal-bottom">
          ...
          <span className={animating ? "slideLeft nav-buttons" : "nav-buttons"}>
            ...
            {activeWelcomePage === 4 && (
              <a
                href="https://github.com/antoniopataro/dona-clone"
                target="_blank"
              >
                <svg
                  width="15"
          ...
          <svg viewBox="0 0 70 10" width="70" height="10">
            <circle
              ...
              cy="5"
              r="5"
              fill={activeWelcomePage === 1 ? "#008FFD" : "#d9d9d9"}
            />
            <circle
              cx="25"
              cy="5"
              r="5"
              fill={activeWelcomePage === 2 ? "#008FFD" : "#d9d9d9"}
            />
            <circle
              cx="45"
              cy="5"
              r="5"
              fill={activeWelcomePage === 3 ? "#008FFD" : "#d9d9d9"}
            />
            <circle
              cx="65"
              cy="5"
              r="5"
              fill={activeWelcomePage === 4 ? "#008FFD" : "#d9d9d9"}
            />
          </svg>
        </div>
      </div>

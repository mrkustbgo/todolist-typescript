...
const ColorPickerStyles = styled.div<Props>`
  ...
  border: ${(props) =>
    props.isSelectingColor ? `1px solid ${props.theme.bold}` : ""};
  box-shadow: ${(props) =>
    props.isSelectingColor ? "0px 0px 16px 4px rgba(0, 0, 0, 0.1)" : ""};
  ...
  animation: ${(props) =>
      props.isSelectingColor ? "colorPickerSlideDown" : "colorPickerSlideUp"}
    0.25s ease;
